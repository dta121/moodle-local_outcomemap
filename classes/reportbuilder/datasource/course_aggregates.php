...
final class course_aggregates extends secured_datasource {
    ...
    protected function initialise_source(): void {
        ...
        $entity
            ...
            ->define_column('courseinstanceid', new lang_string('courseinstance', 'local_outcomemap'),
                column::TYPE_INTEGER, ["{$item}.cinstid"])
            ->define_column('courseinstanceuuid', new lang_string('uuid', 'local_outcomemap'),
                column::TYPE_TEXT, [
            ...
            ->define_filter('courseinstanceid', new lang_string('courseinstance', 'local_outcomemap'),
                number::class, "{$item}.cinstid")
