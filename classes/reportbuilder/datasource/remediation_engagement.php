...
final class remediation_engagement extends secured_datasource {
    ...
    protected function initialise_source(): void {
        ...
        $entity
            ...
            ->define_column(
                'engagementid',
                new lang_string('reportcolumn_engagementid', 'local_outcomemap'),
                column::TYPE_INTEGER,
                ["{$engagement}.id"],
                true,
                null,
            ...
            ->define_column(
                'engagementuuid',
                new lang_string('reportcolumn_engagementuuid', 'local_outcomemap'),
                column::TYPE_TEXT,
                ["{$engagement}.eventuuid"]
            )
            ->define_column(
                'engagementtype',
                new lang_string('reportcolumn_engagementtype', 'local_outcomemap'),
                column::TYPE_TEXT,
            ...
            ->define_column(
                ...
                true,
                [\local_outcomemap\reportbuilder\local\format::class, 'user_fullname'],
                ['lastname', 'firstname']
            )
            ->define_column(
                'resultid',
                new lang_string('reportcolumn_resultid', 'local_outcomemap'),
                column::TYPE_INTEGER,
                ["{$engagement}.resultid"],
                true,
                null,
            ...
            ->define_column(
                'engagementtime',
                new lang_string('reportcolumn_engagementtime', 'local_outcomemap'),
            ...
            ->define_column(
                'title',
                new lang_string('title', 'local_outcomemap'),
                column::TYPE_TEXT,
                ["{$recommendation}.title"]
            )
            ->define_column(
                'explanation',
                new lang_string('explanation', 'local_outcomemap'),
                column::TYPE_LONGTEXT,
                ["{$recommendation}.explanation"]
            )
            ->define_column(
                'targettype',
                new lang_string('targettype', 'local_outcomemap'),
                column::TYPE_TEXT,
                ["{$recommendation}.targettype"]
            )
            ->define_column(
                'targetid',
                new lang_string('target', 'local_outcomemap'),
                column::TYPE_INTEGER,
                ["{$recommendation}.targetid"]
            )
            ->define_column(
                'coursemoduleid',
                new lang_string('coursemodule', 'local_outcomemap'),
                column::TYPE_INTEGER,
                ["{$coursemodule}.id"]
            )
            ->define_column(
                'sectionname',
                new lang_string('coursesection', 'local_outcomemap'),
                column::TYPE_TEXT,
                ["{$section}.name"]
            )
            ->define_column(
                'externalurl',
                new lang_string('externalurl', 'local_outcomemap'),
                column::TYPE_LONGTEXT,
            ...
            ->define_column(
                'priority',
                new lang_string('priority', 'local_outcomemap'),
                column::TYPE_INTEGER,
                ["{$recommendation}.priority"]
            )
            ->define_column(
                'sortorder',
                new lang_string('displayorder', 'local_outcomemap'),
                column::TYPE_INTEGER,
                ["{$recommendation}.sortorder"]
            )
            ->define_column(
                'required',
                new lang_string('requiredremediation', 'local_outcomemap'),
                column::TYPE_BOOLEAN,
            ...
            ->define_column(
                'minpercent',
                new lang_string('minpercent', 'local_outcomemap'),
                column::TYPE_TEXT,
                ["{$recommendation}.minpercent"],
                true,
                null,
                [],
                true
            ...
            ->define_column(
                'maxpercent',
                new lang_string('maxpercent', 'local_outcomemap'),
                column::TYPE_TEXT,
                ["{$recommendation}.maxpercent"],
                true,
                null,
                [],
                true
            ...
            ->define_filter(
                ...
                \local_outcomemap\reportbuilder\local\filters\cohort_membership::class,
                "{$engagement}.userid"
            )
            ...
            ->define_filter(
                ...
                select::class,
                "{$recommendation}.targettype",
                filter_options::remediation_targets()
            )
            ->define_filter(
                'purpose',
                new lang_string('remediationpurpose', 'local_outcomemap'),
                select::class,
                "{$recommendation}.purpose",
                filter_options::remediation_purposes()
            )
            ->define_filter(
                'required',
                new lang_string('requiredremediation', 'local_outcomemap'),
