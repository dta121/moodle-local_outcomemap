...
final class student_attainment extends secured_datasource {
    ...
    protected function initialise_source(): void {
        ...
        $entity
            ...
            ->define_column(
                'distinctitems',
                new lang_string('contributingitems', 'local_outcomemap'),
                column::TYPE_INTEGER,
            ...
            ->define_column(
                'stale',
                new lang_string('resultstate_stale', 'local_outcomemap'),
                column::TYPE_BOOLEAN,
                ["{$result}.stale"],
                true,
            ...
            ->define_column(
                'timecalculated',
                new lang_string('calculationtimestamp', 'local_outcomemap'),
