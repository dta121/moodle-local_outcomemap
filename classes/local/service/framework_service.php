...
final class framework_service extends base_service {
    ...
    public static function create(array $data): int {
        ...
        try {
            ...
            $record->id = $id;
            audit_writer::write('create', 'framework', $id, $record->uuid, null, $record, null,
    ...
    public static function update(int $id, array $data): void {
        ...
        try {
            ...
            audit_writer::write('update', 'framework', $id, $after->uuid, $before, $after,
    ...
    public static function submit_for_review(int $id, ?string $reason = null): void {
        self::change_status($id, workflow::DRAFT, workflow::NEEDS_REVIEW, 'submit_review', $reason,
            'local/outcomemap:manageframeworks', false);
    }
    ...
    private static function change_status(int $id, string $required, string $status, string $action,
        ...
        try {
            $DB->update_record(self::TABLE, $after);
            audit_writer::write($action, 'framework', $id, $after->uuid, $before, $after, $reason,
                \context_system::instance(), $actorid);
    ...
    private static function require_unique(string $uuidvalue, string $ownertype, ?int $ownerid,
            string $code, int $excludeid = 0): void {
        global $DB;
