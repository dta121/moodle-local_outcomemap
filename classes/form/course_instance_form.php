...
final class course_instance_form extends \moodleform {
    public function definition(): void {
        ...
        $mform->addElement('autocomplete', 'courseid', get_string('catalogcourse', 'local_outcomemap'),
            $choose + $catalogcourses);
        $mform->setType('courseid', PARAM_INT);
        $mform->addRule('courseid', null, 'required');
        $mform->addElement('autocomplete', 'moodlecourseid', get_string('moodlecourse', 'local_outcomemap'),
