...
$string['quickmap_heading'] = 'Quick-map an outcome';
$string['quickmap_help'] = 'Choose an outcome and role, tick the sections or activities it applies to, then save. Mappings are created as drafts.';
$string['quickmap_select'] = 'Select';
$string['quickmap_courseoutcomes'] = 'Outcomes for this course';
$string['quickmap_otheroutcomes'] = 'Other approved outcomes';
$string['quickmap_submit'] = 'Map outcome to selected content';
$string['quickmap_notargets'] = 'Select at least one section or activity to map.';
$string['quickmap_created'] = '{$a} mapping(s) created.';
$string['quickmap_skipped'] = '{$a} target(s) were skipped:';
