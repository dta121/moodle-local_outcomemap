...
$string['retention_institutional_record_anonymised'] = 'Retain de-identified frozen institutional records';
$string['retention_privacy_deletion'] = 'Remove subject-level frozen records when an approved privacy deletion applies';
...
$string['snapshotsubjecthashmethod'] = 'Snapshot-specific HMAC-SHA-256 keyed by the protected Moodle site secret';
