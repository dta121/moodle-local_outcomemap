...
$string['nav_policies'] = 'Calculation policies';
...
$string['policies_heading'] = 'Calculation policies';
...
$string['policies_intro'] = 'Create and edit draft policies here, then submit them to the approval queue. No institutional threshold or attempt-selection policy is created automatically.';
